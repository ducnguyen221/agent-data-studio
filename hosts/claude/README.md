...
không đụng server khác), copy 4 skill vào `~/.claude/skills/` và 6 lệnh `/powerbi-*` vào
...
Plugin `powerbi-agent` xuất hiện trong danh sách plugin của app; nạp **4 skill + 6 lệnh /powerbi-* +
